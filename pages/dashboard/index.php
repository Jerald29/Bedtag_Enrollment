                ...
                <div class="row">
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                      ...
                      <a href="<?php echo $_SESSION['role']== "Registrar" || $_SESSION['role']== "Super Administrator" ? "../dashboard/list.enrolled.students.php" : "#"?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                      ...
                      <a href="<?php echo $_SESSION['role']== "Registrar" || $_SESSION['role']== "Super Administrator"  ? "../dashboard/list.pending.students.php" : "#"?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-primary">
                      ...
                      <a href="<?php echo $_SESSION['role']== "Registrar" || $_SESSION['role']== "Super Administrator" ? "../dashboard/list.new.students.php" : "#"?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                      ...
                      <a href="<?php echo $_SESSION['role']== "Registrar" || $_SESSION['role']== "Super Administrator" ? "../dashboard/list.old.students.php" : "#"?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                      ...
                      <a href="<?php echo $_SESSION['role']== "Registrar" || $_SESSION['role']== "Super Administrator" ? "../dashboard/list.disapproved.students.php" : "#"?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                  <div class="col-lg-3 col-6">
