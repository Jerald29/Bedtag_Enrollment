                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <form action="userData/ctrl.edit.strand.php?strand_id=<?php echo $strand_id?>" enctype="multipart/form-data" method="POST">
                                    ...
                                    <?php
                                    $strands_info = mysqli_query($conn, "SELECT * FROM tbl_strands WHERE strand_id = '$strand_id'");
                                    while ($row = mysqli_fetch_array($strands_info)) {
                                    ?>
                                    <div class="card-body">
                                    <div class="row mb-4 mt-4 ">
                                        <div class="input-group col-md-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="strand_name"
                                                placeholder="Enter Strand Abrreviation" value="<?php echo $row['strand_name']?>" required>
                                        </div>
